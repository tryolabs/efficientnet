...
# Tensorflow and TensorRT must share gpu discretly
gb_4 = 4 << 30
gb_1_5 = 3 << 29
TRT_GPU_BYTES = gb_1_5  # <= 37.5% of 4GB in Bytes
GPU_FRACTION = 1 - gb_1_5/gb_4
...
FROZEN_GRAPH_FILENAME = "./models/TensorRT_B3_model.pb"
...
def predict():
    ...
    y = graph.get_tensor_by_name('prefix/activation_27/Softmax:0')
...
with open("last_results.txt", "w+") as f:
    ...
    accuracy_str = "Accuracy: {accuracy:.2f}% \n"
